...
class HipChatHandler extends SocketHandler
{
	 ...
	 * @param string  $format The format of the messages (default to text, can be set to html if you have html in
	 *                        the messages)
	 */
	...
	private function combineRecords($records)
	{
		...
		foreach ($records as $record) {
			...
			$batchRecord = array('message'   => $messgeStr,
		...
		foreach ($batchRecords as &$batchRecord) {
			$batchRecord = array_merge($batchRecord, array('level'      => $level,
	...
	{
		$dataArray = array('from'           => $this->name,
		                   'room_id'        => $this->room,
		                   'notify'         => $this->notify,
