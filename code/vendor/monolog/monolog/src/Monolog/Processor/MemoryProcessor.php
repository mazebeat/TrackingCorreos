...
{
	/**
	 * @var boolean If true, get the real size of memory allocated from system. Else, only the memory used by
	 *      emalloc() is reported.
	 */
	protected $realUsage;
	 ...
	 * @param boolean $useFormatting If true, then format memory size to human readable string (MB, KB, B depending
	 *                               on size)
	 */
