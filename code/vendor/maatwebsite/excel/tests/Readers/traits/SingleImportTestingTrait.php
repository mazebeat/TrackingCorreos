...
trait SingleImportTestingTrait
{
	...
	public function testToArray()
	{
		...
		$this->assertEquals(array(
			...
			array('heading_one' => 'test', 'heading_two' => 'test', 'heading_three' => 'test',), array('heading_one' => 'test', 'heading_two' => 'test', 'heading_three' => 'test',), array('heading_one' => 'test', 'heading_two' => 'test', 'heading_three' => 'test',), array('heading_one' => 'test', 'heading_two' => 'test', 'heading_three' => 'test',), array('heading_one' => 'test', 'heading_two' => 'test', 'heading_three' => 'test',)
	...
	public function testImportedHeadingsSlugged()
	{
		...
		$this->assertEquals(array('heading_one', 'heading_two', 'heading_three'), $keys);
	}
	...
	public function testImportedHeadingsHashed()
	{
		...
		$this->assertEquals(array(md5('heading one'), md5('heading two'), md5('heading three')), $keys);
	}
	...
	public function testImportedHeadingsNumeric()
	{
		...
		$this->assertEquals(array(1, 2, 3), $keys);
	}
	...
	public function testImportedHeadingsOriginal()
	{
		...
		$this->assertEquals(array('heading one', 'heading two', 'heading three'), $keys);
	}
