...
class CliDumper extends AbstractDumper
{
	...
	protected $styles = array(// See http://en.wikipedia.org/wiki/ANSI_escape_code#graphics
		'default'   => '38;5;208',
		'num'       => '1;38;5;38',
		'const'     => '1;38;5;208',
		'str'       => '1;38;5;113',
	...
	public function __construct($output = null)
	{
		...
		if (defined('PHP_WINDOWS_VERSION_MAJOR') && false !== @getenv('ANSICON')) {
			...
			$this->setStyles(array('default' => '31',
			                       'num'     => '1;34',
			                       'const'   => '1;31',
			                       'str'     => '1;32',
			                       'note'    => '34',
	...
	public function dumpString(Cursor $cursor, $str, $bin, $cut)
	{
		...
		if ('' === $str) {
			...
			$attr = array('length' => function_exists('iconv_strlen') && 0 <= $cut ? iconv_strlen($str, 'UTF-8') + $cut : 0,
			              'binary' => $bin,);
			$str  = explode("\n", $str);
			$m    = count($str) - 1;
			$i    = $lineCut = 0;
