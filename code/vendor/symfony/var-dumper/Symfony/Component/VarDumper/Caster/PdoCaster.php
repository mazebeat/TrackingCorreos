...
class PdoCaster
{
	private static $pdoAttributes = array('CASE'               => array(\PDO::CASE_LOWER   => 'LOWER',
	                                                                    \PDO::CASE_NATURAL => 'NATURAL',
	                                                                    \PDO::CASE_UPPER   => 'UPPER',),
	                                      'ERRMODE'            => array(\PDO::ERRMODE_SILENT    => 'SILENT',
		...
		'DRIVER_NAME',
		'SERVER_INFO',
	                                      'ORACLE_NULLS'       => array(\PDO::NULL_NATURAL      => 'NATURAL',
		...
		'CONNECTION_STATUS',
		'STRINGIFY_FETCHES',
	                                      'DEFAULT_FETCH_MODE' => array(\PDO::FETCH_ASSOC => 'ASSOC',
	                                                                    \PDO::FETCH_BOTH  => 'BOTH',
	                                                                    \PDO::FETCH_LAZY  => 'LAZY',
	                                                                    \PDO::FETCH_NUM   => 'NUM',
	                                                                    \PDO::FETCH_OBJ   => 'OBJ',),);
	...
	public static function castPdo(\PDO $c, array $a, Stub $stub, $isNested)
	{
		...
		$m = "\0~\0";
		$a = (array)$c + array($m . 'inTransaction' => method_exists($c, 'inTransaction'),
