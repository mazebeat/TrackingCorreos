...
class MongoDbSessionHandler implements \SessionHandlerInterface
{
	...
	public function __construct($mongo, array $options)
	{
		...
		$this->options = array_merge(array('id_field'   => '_id',
		                                   'data_field' => 'data',
		                                   'time_field' => 'time',), $options);
	}
	...
	{
		$this->getCollection()->update(array($this->options['id_field'] => $sessionId), array('$set' => array($this->options['data_field'] => new \MongoBinData($data, \MongoBinData::BYTE_ARRAY),
		                                                                                                      $this->options['time_field'] => new \MongoDate(),)), array('upsert'   => true,
		                                                                                                                                                                 'multiple' => false));
